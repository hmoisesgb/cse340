...
/* Insert values in classification table */
...
/* Create relationships for the favorites table with the inventory and account tables */
...
ALTER TABLE public.favorites
  ADD CONSTRAINT fk_favorites_inventory
  FOREIGN KEY (inv_id)
